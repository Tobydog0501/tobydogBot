...
module.exports = {
    data: new SlashCommandBuilder()
        .setName("move")
        .setDescription("Move")
        .addIntegerOption(new SlashCommandIntegerOption().setName("track").setDescription("The track number you want to move").setRequired(true))
        .addIntegerOption(new SlashCommandIntegerOption().setName("position").setDescription("The position to move it to").setRequired(true)),
    name: 'move',

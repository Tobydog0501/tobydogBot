...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addIntegerOption(new SlashCommandIntegerOption().setName("track1").setDescription("The track number you want to swap").setRequired(true))
        .addIntegerOption(new SlashCommandIntegerOption().setName("track2").setDescription("The track number you want to swap").setRequired(true)),
    name: 'swap',
